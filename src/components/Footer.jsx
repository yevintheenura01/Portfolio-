        ...
        <div className="glass-card flex flex-col gap-6 rounded-[1.75rem] px-7 py-6 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 rounded-full border transition-all duration-300 px-4 py-2 dark:border-white/20 dark:bg-white/5 dark:hover:bg-white/10 border-emerald-200 bg-emerald-100 hover:bg-emerald-100"
            >
              <GithubIcon />
              GitHub
            </a>
