...
export function ResumeButton({ showToast }) {
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.95 }}
      className="inline-flex items-center gap-2 rounded-full border transition-all duration-300 px-6 py-3 font-semibold dark:border-cyan-300/40 dark:bg-cyan-300/15 dark:text-cyan-100 dark:hover:bg-cyan-300/25 border-green-400 bg-green-100 text-green-800 hover:bg-green-100 disabled:opacity-50 disabled:cursor-not-allowed"
    >
      {isLoading ? (
        <>
          <motion.span
