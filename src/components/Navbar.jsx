    ...
    <header className="sticky top-0 z-50 px-4 pt-4 pointer-events-none">
      <motion.nav
        ...
        className={cn(
          ...
          "border-green-300 bg-white/85 shadow-lg backdrop-blur-lg",
        )}
      >
        <a
          href="#hero"
          className="font-display text-2xl tracking-wide dark:text-white text-green-800 transition-colors hover:dark:text-cyan-200 hover:text-green-700"
        >
          Portfolio
        </a>
        ...
        <div className="hidden items-center gap-7 text-sm font-medium dark:text-slate-200 text-slate-900 lg:flex">
          {links.map((link) => (
            <a
              key={link.label}
              href={link.href}
              className="transition-colors hover:dark:text-cyan-200 hover:text-green-700"
            >
              {link.label}
            </a>
          ))}
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            href="#contact"
            className="rounded-full border transition-all duration-300 px-5 py-2.5 text-sm font-semibold dark:border-cyan-300/40 dark:bg-cyan-300/15 dark:text-cyan-100 dark:hover:bg-cyan-300/25 border-green-400 bg-green-100 text-green-800 hover:bg-green-100"
          >
            Contact
          </a>
        </div>
