      ...
      >
        ...
        >
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2 xl:grid-cols-4 text-base dark:text-slate-200 text-slate-700 transition-colors duration-300">
            <a
              className="flex items-center gap-3 rounded-2xl border transition-all duration-300 px-5 py-4 dark:border-white/20 dark:bg-white/5 dark:hover:bg-white/10 border-emerald-200 bg-emerald-100 hover:bg-emerald-100"
              href="mailto:yevintheenura.dev@gmail.com"
            >
              <span className="grid h-10 w-10 place-items-center rounded-full dark:bg-cyan-300/15 dark:text-cyan-200 bg-emerald-100 text-emerald-600 transition-all duration-300">
                <MailIcon />
              </span>
              <span>
          ...
          >
            ...
            <button
              type="submit"
              className="rounded-full border transition-all duration-300 px-6 py-3 text-base font-semibold dark:border-cyan-300/35 dark:bg-cyan-300/15 dark:text-cyan-100 dark:hover:bg-cyan-300/25 border-emerald-300 bg-emerald-100 text-emerald-700 hover:bg-emerald-100 md:col-span-2 md:justify-self-start"
            >
              Send Message
            </button>
          </form>
