            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-4 rounded-lg dark:bg-white/5 bg-green-100/40 p-3 border transition-all duration-300 dark:border-white/10 border-green-300">
                    <p className="text-sm font-semibold dark:text-cyan-200 text-green-700 transition-colors duration-300">
                      Key Learning:
                    </p>
